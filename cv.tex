...
\newcommand{\dates}[2]{\textbf{\hangleft{\includegraphics[scale=0.05]{pics/calendar.png} }#1–#2} \par}
...
%   \renewcommand{\arraystretch}{1.5}
  \begin{tabular}{@{}ll}
    Name: & Andrei Matveiakin \\
          & \alternative{\hangleft{(}Андрей Матвеякин)} \gap \\
    Address: & Schaufelbergerstrasse 57, \\
             & 8055 Zürich, Switzerland \gap \\
    Phone: & +41~79~315-04-02 \gap \\
    E-mail \& Hangouts: & \mailto{matveyakin@gmail.com} \gap \\
    Skype: & matveyakin
  \end{tabular}
\end{items}
...
\Section{Education}
\begin{items}
  \item \dates{2007}{2012}
  In 2012 I graduated with Honors
...
\begin{items}
  \item \dates{2010}{2014}  % TODO
  Software developer at \href{http://rfdyn.com/about/}{Rock Flow Dynamics}.
...
%   \item These are the major tasks I have been performing (in groups of 3 to 6 people):
  Major problems I have been solving (in groups of 3 to 6 people):
  \begin{subitems}
    ...
    \item And the main thing---history matching module. In a nutshell, history matching is an inverse problem to the equation that tNavigator usually solves. The aim is to find a set of coefficients for which the solution minimizes a functional describing deviation between calculated and historical values. This project included a lot of subtasks, such as implementing and tuning minimization algorithms, developing a computational queue manager, and writing a GUI that displays graphs and diagrams for huge amounts of data which don't fit in RAM.
  \end{subitems}

  \item \dates{2014}{present}
  Software developer at \href{https://www.google.com/about/company/}{Google}.
  Work on Search Infrastructure, powering Google's indexing applications.
\end{items}
\newpage
...
\begin{items}
  ...
  write scripts in Python and Bash when necessary. \\
