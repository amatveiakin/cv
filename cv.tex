...
\SectionQ{Personal Information}{me.jpg}{0.22}{-3.4cm}
\begin{items}
  \item My name is Andrei Matveiakin \alternative{(Андрей Матвеякин).}

  \item I live at \\
  Schaufelbergerstrasse 57, 8055 Zürich, Switzerland

  \item You can contact me by \\
  \begin{tabular}{@{}ll}
    phone: & +7~985~967-02-63, \\
...
\Section{Education}
\begin{items}
  \item In 2012 I have graduated with Honors \\
...
\Section{Languages}
\begin{items}
  \item Russian is my mother tongue, \\
  I speak English fairly fluently, \\
  and have a little grasp of French.
\end{items}


% По желанию :)
\Section{Interests}
\SectionComment{(besides programming :-)}   % Do we need the joke?
\begin{items}
  \item First of all, board games, both paying and inventing new ones. I am particularly fascinated with bughouse chess. \\
  My favorite sports are volleyball and table tennis. I also enjoy camping trips. \\
  And I like listening to music and singing to a guitar in a good company.
\end{items}
\bigskip
\bigskip
...
\vfill
\begin{raggedleft}
  \scriptsize\textsl{Compilation date — February 16, 2014}   % TODO: Set date automatically
